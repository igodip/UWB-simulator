...
#ifndef UWB_MODULE_SPECTRUM_VALUE_HELPER_H
#define UWB_MODULE_SPECTRUM_VALUE_HELPER_H
...
namespace ns3 {
	...
	class UwbModuleSpectrumValueHelper
	{
	public:
		UwbModuleSpectrumValueHelper(void);
		virtual ~UwbModuleSpectrumValueHelper(void);
